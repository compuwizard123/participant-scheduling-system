...
urlpatterns = patterns('',
    ...
    url(r'^appointments/create/(?P<experiment_id>[\d]+)/$', views.appointment_view, name='main-create_appointment'),
    url(r'^appointments/edit/(?P<appointment_id>[\d]+)/$', views.appointment_view, name='main-edit_appointment'),
